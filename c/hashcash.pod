...
If used with the I<-d> option, the spent stamp and it's expiry period
...
When checking stamps, allow wildcards I<*> in the resource name to
...
to those in stamps.  See also I<-W>, <-E> and I<-C>.
...
get a stamp 1 bit larger; similarly with decreasing probability you
can get even larger stamps.
...
The first field of the stamp is the UTC time since 1st January 1970.
...
stamp and it's expiry period is written to the database file.  The
